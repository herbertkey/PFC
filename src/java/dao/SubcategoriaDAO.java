...
public class SubcategoriaDAO {
    ...
    private static final String CONSULTA_UMA_SUBCATEGORIA = "SELECT id, subcategoria, prioridade, categoria FROM subcategoria Where upper(subcategoria)=?";
    ...
    public Subcategoria consultaUmaSubcategoria(Subcategoria subcategoria) throws ClassNotFoundException, SQLException {
        ...
        try {
            ...
            //SELECT subcategoria,prioridade,categoria FROM subcategoria Where upper(subcategoria)=?
            pstmt.setString(1, subcategoria.getSubcategoria().toUpperCase());
            pstmt.execute();
            ResultSet resultado = pstmt.executeQuery();
            s = new Subcategoria();
